#' Reads in HOMER tags file, creates a data frame containing reads in a region of interest
#'
...
#' @return A cleaned-up data frame of HOMER tags in a region of interest.
#'
#' @export
