...
#'
#' @param truncated_m a binned contact-matrix generated by truncate_matrix().
#' @param title A plot title, default = T2C results.
#' @param black_cells A data frame of array indices generated by blackout_cells().
...
plot_results<-function(truncated_m, title = c("T2C results"), black_cells, colors_palette = c("blue","deepskyblue2","green","yellow","orange","red","red3")){
